...
# =========================
SERIAL_PORT = "COM9  "  # Hardcoded to COM8, no override
SERIAL_BAUD = 9600    # Baud rate must match Arduino
serial_conn = None
...
def get_serial_connection():
    """Initialize serial connection if not already opened."""
    global serial_conn
...
def serial_event():
    ...
    if ser:
        try:
            # Convert dict to JSON string + send with newline
